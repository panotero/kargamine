...
--
-- Host: 118.139.180.82    Database: db_kargamine
-- ------------------------------------------------------
...
CREATE TABLE `app_theme_settings` (
  ...
  `main_color` varchar(255) NOT NULL DEFAULT 'blue',
  `accent_color` varchar(255) NOT NULL DEFAULT 'orange',
  `button_secondary_color` varchar(255) NOT NULL DEFAULT 'slate',
  `button_danger_color` varchar(255) NOT NULL DEFAULT 'red',
  `dark_mode` varchar(255) NOT NULL DEFAULT 'system',
...
CREATE TABLE `booking_container_eir_records` (
  ...
  `damage_codes` varchar(255) DEFAULT NULL,
  `damage_remarks` text DEFAULT NULL,
  `convan_checklist_path` varchar(255) DEFAULT NULL,
  ...
  `shipper_representative_name` varchar(255) DEFAULT NULL,
  `driver_id_photo_path` varchar(255) DEFAULT NULL,
  `issued_by` bigint(20) unsigned DEFAULT NULL,
...
CREATE TABLE `booking_container_units` (
  ...
  `proforma_bl_number` varchar(255) DEFAULT NULL,
  `waybill_number` varchar(255) DEFAULT NULL,
  `gate_pass_out_number` varchar(255) DEFAULT NULL,
...
CREATE TABLE `booking_dispatch_documents` (
  ...
  `trailer_capacity` varchar(255) DEFAULT NULL,
  `convan_count` int(10) unsigned DEFAULT NULL,
  `convan_size` varchar(255) DEFAULT NULL,
  `authorized_trucker` varchar(255) DEFAULT NULL,
  `plate_number` varchar(255) DEFAULT NULL,
  `authorized_driver` varchar(255) DEFAULT NULL,
  `helper` varchar(255) DEFAULT NULL,
  `coordinator_checker` varchar(255) DEFAULT NULL,
...
CREATE TABLE `booking_lines` (
  ...
  `discount_type_snapshot` varchar(255) DEFAULT NULL,
  ...
  `consignee_contact_person` varchar(255) DEFAULT NULL,
  `consignee_contact_number` varchar(255) DEFAULT NULL,
  `cargo_type` varchar(255) DEFAULT NULL,
  `other_cargo_details` text DEFAULT NULL,
  `declared_value` decimal(14,2) DEFAULT NULL,
  `delivery_date` date DEFAULT NULL,
  `delivery_date_notes` varchar(255) DEFAULT NULL,
...
CREATE TABLE `booking_port_charges` (
  ...
  `role` enum('ORIGIN','DESTINATION') NOT NULL,
...
INSERT INTO `cache` VALUES ('management_system_cache_7f3072bf378b98d6bbf2f013cff3e287','i:14;',1785767414),('management_system_cache_7f3072bf378b98d6bbf2f013cff3e287:timer','i:1785767414;',1785767414),('management_system_cache_a3affa0d1e1a3c72b78aa984c3367a05','i:5;',1785201511),('management_system_cache_a3affa0d1e1a3c72b78aa984c3367a05:timer','i:1785201511;',1785201511),('management_system_cache_d2bfa8e8b749d2772a21edee7b70a2b3','i:1;',1785776924),('management_system_cache_d2bfa8e8b749d2772a21edee7b70a2b3:timer','i:1785776924;',1785776924),('management_system_cache_de226f3f5dc0c66a464effdc07ca6b1f','i:1;',1785170219),('management_system_cache_de226f3f5dc0c66a464effdc07ca6b1f:timer','i:1785170219;',1785170219),('management_system_cache_f1f70ec40aaa556905d4a030501c0ba4','i:1;',1785778437),('management_system_cache_f1f70ec40aaa556905d4a030501c0ba4:timer','i:1785778437;',1785778437);
...
CREATE TABLE `charge_types` (
  ...
  `applicable_to` varchar(255) NOT NULL DEFAULT 'PORT',
...
INSERT INTO `client_addresses` VALUES (2,4,NULL,1,'12','12','12','Agtangao','Bangued','Abra','Philippines','123123','2026-08-03 16:23:17','2026-08-03 16:23:17'),(3,5,NULL,1,'12','test','test','Agtangao','Bangued','Abra','Philippines','123','2026-08-04 08:27:30','2026-08-04 08:27:30');
...
CREATE TABLE `client_ancillary_services` (
  ...
  `client_mnemonic` varchar(255) DEFAULT NULL,
  `client_business_name` varchar(255) DEFAULT NULL,
  `required_service` varchar(255) DEFAULT NULL,
  `location` varchar(255) DEFAULT NULL,
  `unit` varchar(255) DEFAULT NULL,
  `unit_rate_vat_ex` decimal(15,2) DEFAULT NULL,
...
INSERT INTO `client_ancillary_services` VALUES (2,4,'CM-2026-0003','Asd','asd','123','qwe','123',123.00,'Check','qweqeqew','2026-08-04 08:30:01','2026-08-04 08:30:01');
...
INSERT INTO `client_contact_addresses` VALUES (1,2,'Warehouse',1,'123','123','testing','Agtangao','Bangued','Abra','Philippines','TESTING','2026-08-04 08:28:04','2026-08-04 08:28:04'),(2,3,NULL,1,'123','123','qwe','Agtangao','Bangued','Abra','Philippines','123123','2026-08-04 08:29:55','2026-08-04 08:29:55');
...
CREATE TABLE `client_contacts` (
  ...
  `landline_type` varchar(255) DEFAULT NULL,
...
INSERT INTO `client_contacts` VALUES (2,5,'qweqwe','2026-08-04 08:28:04','2026-08-04 08:28:04','Mr.','testing','testing','Male','test','123123','personal','1231212121212','personal','panoterominton@gmail.com','personal'),(3,4,'qwe','2026-08-04 08:29:55','2026-08-04 08:29:55','Mr.','qwe','qwe','Male','qwe','123','personal','123123','personal','test@email.com','personal');
...
INSERT INTO `client_contract_rates` VALUES (3,2,2,22,2,1,2,5,10,500.00,'percentage',10.00,450.00,'2026-08-04 08:31:30','2026-08-04 08:31:30');
...
INSERT INTO `client_contracts` VALUES (2,'932ef488-2b60-4343-96b4-a4c98db57e11','CCT-202608-0001',4,13,'2026-08-04','2026-08-01','2026-09-05',2,NULL,NULL,NULL,NULL,1,'2026-08-04 08:31:30','2026-08-04 08:31:30');
...
CREATE TABLE `client_finance` (
  ...
  `tin_registered_address` text DEFAULT NULL,
...
INSERT INTO `client_finance` VALUES (2,4,'asd',NULL,'2026-08-03 16:26:12','2026-08-04 08:29:03','123','qweqewqwe','123','123','qweqweqe',NULL,'qweqeqe',123.00,123.00,'Check',13,123123.00),(3,5,'test','90 Days','2026-08-04 08:28:36','2026-08-04 08:28:36','123','qweqaweawe','123','123','qweqweqwqwe','2026-08-01','qweqeqe',12.00,12.00,'Check',13,123123.00);
...
CREATE TABLE `client_masters` (
  ...
  `client_classification` varchar(255) DEFAULT NULL,
...
INSERT INTO `client_masters` VALUES (4,'a26a4baa-edd7-492c-9f1f-113cc6a0203e',6,'CM-2026-0003','asd','Asd',NULL,NULL,0,'Agriculture',1,NULL,4,1,1,'2026-08-03 16:23:17','2026-08-04 08:29:55'),(5,'a26a62a2-3cb3-454b-bf0c-539a4cf8d1b8',13,'CM-2026-0002','test','TST','Corporate Account','Regular',0,'Retail',1,NULL,4,1,1,'2026-08-04 08:27:30','2026-08-04 08:28:39');
...
INSERT INTO `client_proposal_rates` VALUES (9,12,2,22,2,1,2,5,NULL,123.00,NULL,0.00,123.00,'2026-08-03 14:37:57','2026-08-03 14:37:57'),(10,13,2,22,2,1,2,5,NULL,123.00,NULL,0.00,123.00,'2026-08-03 16:01:00','2026-08-03 16:01:00'),(11,14,2,22,2,1,1,4,12,123.00,'percentage',10.00,110.70,'2026-08-03 16:04:35','2026-08-03 16:04:35');
...
INSERT INTO `client_proposals` VALUES (12,'f1e524ba-7e8c-4211-9ba3-681d0d307565','CPR-202608-0001',5,13,4,'[\"http:\\/\\/kargamine_prototype.test\\/uploads\\/doc\\/pdf\\/7edc0b70db0b8a995b95643dc22cbd965aac4b14dfd3162d2e6d20fe2408d5fb.pdf\"]','2026-08-03 14:38:26',1,'2026-08-03 14:38:05',NULL,1,'2026-08-03 14:37:56','2026-08-04 08:27:30'),(13,'0b226762-2735-4118-954f-11cca451bd82','CPR-202608-0002',4,6,4,'[\"http:\\/\\/kargamine_prototype.test\\/uploads\\/doc\\/pdf\\/ccf891ee50ff8a8f516a3fa647ee9691d3a2056b674806cfb9ed726ffe91589d.pdf\"]','2026-08-03 16:01:19',3,'2026-08-03 16:01:10',NULL,3,'2026-08-03 16:01:00','2026-08-03 16:23:17'),(14,'df84cc3c-157d-4022-91ed-dfc5cfde8e00','CPR-202608-0003',NULL,10,1,NULL,NULL,NULL,NULL,NULL,3,'2026-08-03 16:04:35','2026-08-03 16:04:35');
...
CREATE TABLE `company_finance` (
  ...
  `company_id` bigint(20) unsigned NOT NULL,
  `credit_terms` varchar(255) DEFAULT NULL,
  `invoice_mode` varchar(255) DEFAULT NULL,
...
CREATE TABLE `company_info_master` (
  ...
  `customer_type` enum('shipper','consignee','both') NOT NULL,
...
CREATE TABLE `container_asset_location_history` (
  ...
  `port_id` bigint(20) unsigned NOT NULL,
  `pier_reference` varchar(255) DEFAULT NULL,
  `status_at_time` varchar(255) NOT NULL,
...
CREATE TABLE `container_assets` (
  ...
  `current_pier_reference` varchar(255) DEFAULT NULL,
...
CREATE TABLE `courier_invoice` (
  ...
  `invoice_contact_number` text DEFAULT NULL,
  `invoice_courier_address` text DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `crm_company_info` (
  ...
  `authorized_signatory_title` varchar(255) DEFAULT NULL,
  `authorized_signatory_first_name` varchar(255) DEFAULT NULL,
  `authorized_signatory_middle_name` varchar(255) DEFAULT NULL,
  `authorized_signatory_last_name` varchar(255) DEFAULT NULL,
  `authorized_signatory_gender` varchar(255) DEFAULT NULL,
  `authorized_signatory_position` varchar(255) DEFAULT NULL,
  `authorized_signatory_mobile` varchar(255) DEFAULT NULL,
  `authorized_signatory_mobile_type` varchar(255) DEFAULT NULL,
  `authorized_signatory_landline` varchar(255) DEFAULT NULL,
  `authorized_signatory_landline_type` varchar(255) DEFAULT NULL,
  `authorized_signatory_email` varchar(255) DEFAULT NULL,
  `authorized_signatory_email_type` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `crm_lead_containers` (
  ...
  `booking_unit_type` varchar(255) DEFAULT NULL,
  `quantity` int(11) DEFAULT NULL,
  `declared_value_per_unit` decimal(15,2) DEFAULT NULL,
  `frequency` varchar(255) DEFAULT NULL,
  `general_cargo_description` text DEFAULT NULL,
  `convan_class` varchar(255) DEFAULT NULL,
  ...
  `service_mode_origin` varchar(255) DEFAULT NULL,
  `service_mode_destination` varchar(255) DEFAULT NULL,
  `service_mode` varchar(255) DEFAULT NULL,
  `dangerous_cargo` tinyint(1) NOT NULL DEFAULT 0,
  `dg_documentary_requirement` text DEFAULT NULL,
...
CREATE TABLE `e_invoice` (
  ...
  `invoice_email_cc_address` varchar(255) DEFAULT NULL,
  `invoice_email_bcc_address` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `list_of_values_table` (
  ...
  `lov_code` varchar(255) NOT NULL,
  `lov_name` varchar(255) NOT NULL,
  `lov_description` text DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`lov_id`),
...
INSERT INTO `mailer_settings` VALUES (2,'smtp','localhost','25',NULL,NULL,NULL,'no-reply@synxcel.com','Synxcel Notification','2026-07-27 16:35:01','2026-08-04 08:17:05');
...
INSERT INTO `nav_menus` VALUES (1,'Theme','squares-2x2','/page_theme','[\"4\",\"1\"]',9,3,'2026-07-27 10:35:49','2026-08-04 08:26:13'),(2,'Dashboard','home','/page_dashboard','[\"2\",\"5\",\"4\",\"6\",\"1\",\"3\"]',0,0,'2026-07-27 10:35:57','2026-08-04 08:17:47'),(3,'CRM','flag','/page_crm','[\"2\",\"5\",\"4\",\"6\",\"1\",\"3\"]',0,1,'2026-07-27 10:35:57','2026-08-04 08:17:49'),(4,'Clients','building-office','page_clientMasters','[\"2\",\"5\",\"4\",\"6\",\"1\",\"3\"]',0,3,'2026-07-27 10:35:57','2026-08-04 08:17:58'),(5,'Contracts','document-text','/page_contracts','[\"2\",\"5\",\"4\",\"6\",\"1\",\"3\"]',0,5,'2026-07-27 10:35:57','2026-08-04 08:18:03'),(6,'Users','users','/page_usermanagement','[\"2\",\"4\",\"1\"]',0,10,'2026-07-27 10:35:57','2026-08-04 08:18:28'),(7,'Proposals','paper-airplane','page_proposals','[\"2\",\"5\",\"4\",\"6\",\"1\",\"3\"]',0,2,'2026-07-27 10:35:57','2026-08-04 08:17:56'),(8,'Settings','cog-6-tooth','#','[\"2\",\"4\",\"1\"]',0,11,'2026-07-27 10:35:57','2026-08-04 08:25:27'),(9,'Developer Option','shield-check','#','[\"4\",\"1\"]',0,12,'2026-07-27 10:35:57','2026-08-04 08:26:13'),(10,'Mailer','envelope','/page_mailer','[\"4\",\"1\"]',9,1,'2026-07-27 10:35:57','2026-08-04 08:26:13'),(11,'Menus','bars-3','/page_menus','[\"4\",\"1\"]',9,2,'2026-07-27 10:35:57','2026-08-04 08:26:13'),(12,'Notification Test','bell','/page_notification_test','[\"4\",\"1\"]',9,4,'2026-07-27 10:35:57','2026-08-04 08:26:13'),(13,'App Settings','cog-6-tooth','/page_maintenance','[\"2\",\"4\",\"1\"]',8,0,'2026-07-27 10:35:57','2026-08-04 08:25:27'),(14,'Team Management','briefcase','/page_team_management','[\"2\",\"4\",\"1\"]',8,1,'2026-07-27 10:35:57','2026-08-04 08:25:27'),(15,'Container Inventory','cube','/page_container_inventory','[\"2\",\"4\",\"1\"]',8,2,'2026-07-27 10:55:27','2026-08-04 08:25:27'),(16,'Booking','squares-2x2','page_booking','[\"2\",\"4\",\"5\",\"6\",\"1\",\"3\"]',0,4,'2026-07-27 10:56:08','2026-07-27 18:02:50'),(17,'Cargo Build-Up','archive-box','/page_cargo_build_up','[\"2\",\"5\",\"4\",\"6\",\"1\",\"3\"]',0,7,'2026-07-29 07:18:13','2026-08-04 08:18:12'),(18,'Pier Check-In','check-circle','/page_pier_checkin','[\"2\",\"5\",\"4\",\"6\",\"1\",\"3\"]',0,9,'2026-07-29 10:20:30','2026-08-04 08:18:15'),(19,'Bookings','list-bullet','/page_booking','[\"2\",\"5\",\"4\",\"6\",\"1\",\"3\"]',0,6,'2026-07-29 14:02:56','2026-08-04 08:18:07');
...
INSERT INTO `options_table` VALUES (1,'Address Type',NULL,'2026-07-27 10:35:59','2026-07-27 10:35:59'),(2,'Lead Source',NULL,'2026-07-27 10:35:59','2026-07-27 10:35:59'),(3,'Type of Business',NULL,'2026-07-27 10:35:59','2026-07-27 10:35:59'),(4,'Industry',NULL,'2026-08-03 15:16:47','2026-08-03 15:16:47'),(5,'Type of Organization',NULL,'2026-08-03 15:16:48','2026-08-03 15:16:48'),(6,'Client Category',NULL,'2026-08-03 16:43:53','2026-08-03 16:43:53'),(7,'Client Classification',NULL,'2026-08-03 16:43:54','2026-08-03 16:43:54');
...
INSERT INTO `sessions` VALUES ('0KiLbbfHOk9CInPgCUCuPmFh5zTOc76Xj7xc2eQD',NULL,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36','',1785775710),('0XwouV3lyimttEHGSBpvmx4qKskeOkt2T4QrWpZg',NULL,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Herd/1.28.0 Chrome/120.0.6099.291 Electron/28.2.5 Safari/537.36','',1785337324),('2abAjUl7OxtO1wTWwH3qgchW0lGqlZGwomxluz74',NULL,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Herd/1.28.0 Chrome/120.0.6099.291 Electron/28.2.5 Safari/537.36','',1785337353),('6ZdoMdptmnEofqQ63a0lpun2XqcE1S6s5Q97SvkD',NULL,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Herd/1.28.0 Chrome/120.0.6099.291 Electron/28.2.5 Safari/537.36','',1785337280),('I41dy6lDoUtAyGvjmfCVlwdkN7JqThab1qChaZwk',1,'103.36.18.156','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36','',1785778457),('ixm5geArVr2XuxI5QYLrHuzP6WNyWhlYwVBiseO7',NULL,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Herd/1.28.0 Chrome/120.0.6099.291 Electron/28.2.5 Safari/537.36','',1785239124),('JJjWSuj65l5WByhaW5MtbHisknWml7ypXDfqXiaZ',NULL,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Herd/1.28.0 Chrome/120.0.6099.291 Electron/28.2.5 Safari/537.36','',1785767277),('js4MvQESj0Ut5gsCt5NeCm5pw3lW3tZZlW04KNRh',NULL,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Herd/1.28.0 Chrome/120.0.6099.291 Electron/28.2.5 Safari/537.36','',1785337324),('kLFg12GaEb30H9RnDJ7QhSCyGXaSDh16idnqP0yT',NULL,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Herd/1.28.0 Chrome/120.0.6099.291 Electron/28.2.5 Safari/537.36','',1785767277),('KlHK58zrSxJ3GrMKBJh6SfF36ADSpHMWY9LLxtbg',NULL,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Herd/1.28.0 Chrome/120.0.6099.291 Electron/28.2.5 Safari/537.36','',1785337280),('l4Ttdqe2HrjvK46rfq02MhzbexjEGGVRNMKCoSR1',NULL,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Herd/1.28.0 Chrome/120.0.6099.291 Electron/28.2.5 Safari/537.36','',1785767280),('NBA8hGr3Q3JNzTSjOIXs1LHMyHMFlEOiZhB2Y9X6',4,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36','',1785201451),('qq1J3bqaVPqAWbEhJalr7zpKL4r0QmNXf47dGh6Y',NULL,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Herd/1.28.0 Chrome/120.0.6099.291 Electron/28.2.5 Safari/537.36','',1785239124),('u2YSpMgi8ymZsbV13jR25Rkef1fXJG95hIHiaKoN',NULL,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Herd/1.28.0 Chrome/120.0.6099.291 Electron/28.2.5 Safari/537.36','',1785337353),('wZB7bAnsggZFmJTq0xNoPN4kOlSfrjdenIcYfqmY',3,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36','',1785776864),('z5u5qjEfbBRMe9Zxxl6lDPeIdgJVsWAvyUe1U43K',NULL,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Herd/1.28.0 Chrome/120.0.6099.291 Electron/28.2.5 Safari/537.36','',1785767277),('zAT8m9UdCFd0SW4VjXPuOXq8Mfqr3qpmXCfdW9I8',NULL,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36','',1785337311);
...
INSERT INTO `vat_rates` VALUES (1,20.00,'2026-07-02',NULL,1,'2026-07-28 11:21:57','2026-07-28 11:21:57'),(2,12.00,'2026-07-27',NULL,1,'2026-07-28 11:39:44','2026-07-28 11:39:44');
...
CREATE TABLE `vessel_voyages` (
  ...
  `voyage_mnemonic` varchar(255) NOT NULL,
  `voyage_leg` varchar(255) NOT NULL,
  `origin_port_id` bigint(20) unsigned NOT NULL,
  `destination_port_id` bigint(20) unsigned NOT NULL,
  `estimated_departure_at` timestamp NULL DEFAULT NULL,
  `estimated_arrival_at` timestamp NULL DEFAULT NULL,
...
--
-- Dumping routines for database 'db_kargamine'
--
...
-- Dump completed on 2026-08-04  1:34:44
